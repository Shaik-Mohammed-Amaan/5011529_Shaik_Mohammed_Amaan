...
public class DepartmentController {
    ...
    @GetMapping("/departments/name/pattern/{deptPattern}")
    public List<Department> getDepartmentByNameContaining(@PathVariable String deptPattern){
        return departmentService.getDepartmentByNameContaining(deptPattern);
    }

    //Projection
    @GetMapping("/departments/projection/pattern/{deptPattern}")
    public List<DepartmentDTO> getDepartmentProjectionByNameContaining(@PathVariable String deptPattern){
        return departmentService.getDepartmentProjectionByNameContaining(deptPattern);
    }
