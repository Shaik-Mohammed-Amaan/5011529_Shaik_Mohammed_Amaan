...
public class EmployeeController {
    ...
    //Projections
    @GetMapping("/employees/projection/department/{deptName}")
    public List<EmployeeFullNameProjection> getProjectionByDepartmentName(@PathVariable String deptName) {
        return employeeService.getProjectionByDepartmentName(deptName);
    }

    //Batch processing
    @PostMapping("/employees/batch")
    public void addEmployeesInBatch(@RequestBody List<Employee> employees) {
